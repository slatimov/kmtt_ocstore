...
--
-- Хост: localhost
-- Время создания: Ноя 25 2014 г., 18:35
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@address`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@address` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@affiliate`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@affiliate` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@affiliate_transaction`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@affiliate_transaction` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@attribute`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@attribute` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@attribute`
--

INSERT INTO `@@DB_MAIN_PREFIX@@attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@attribute_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@attribute_description` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@attribute_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@attribute_group`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@attribute_group` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@attribute_group`
--

INSERT INTO `@@DB_MAIN_PREFIX@@attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@attribute_group_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@attribute_group_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Память'),
(4, 1, 'Technical'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@banner`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@banner` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@banner`
--

INSERT INTO `@@DB_MAIN_PREFIX@@banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
(7, 'Samsung Tab', 1),
(8, 'Manufacturers', 1);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@banner_image`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@banner_image` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@banner_image`
--

INSERT INTO `@@DB_MAIN_PREFIX@@banner_image` (`banner_image_id`, `banner_id`, `link`, `image`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@banner_image_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@banner_image_description` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@banner_image_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@banner_image_description` (`banner_image_id`, `language_id`, `banner_id`, `title`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@category`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@category` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@category`
--

INSERT INTO `@@DB_MAIN_PREFIX@@category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@category_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@category_description` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@category_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`) VALUES
(28, 1, 'Мониторы', '', '', '', '', ''),
(33, 1, 'Камеры', '', '', '', '', ''),
(32, 1, 'Веб-камеры', '', '', '', '', ''),
(31, 1, 'Сканеры', '', '', '', '', ''),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@category_filter`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@category_path`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@category_path`
--

INSERT INTO `@@DB_MAIN_PREFIX@@category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@category_to_layout`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@category_to_store`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@category_to_store`
--

INSERT INTO `@@DB_MAIN_PREFIX@@category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@country`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@country` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@country`
--

INSERT INTO `@@DB_MAIN_PREFIX@@country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@coupon`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@coupon` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@coupon`
--

INSERT INTO `@@DB_MAIN_PREFIX@@coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@coupon_category`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@coupon_category` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@coupon_history`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@coupon_history` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@coupon_product`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@coupon_product` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@currency`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@currency` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@currency`
--

INSERT INTO `@@DB_MAIN_PREFIX@@currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_ban_ip`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_ban_ip` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_field`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_field` (
  `customer_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_group`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_group` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@customer_group`
--

INSERT INTO `@@DB_MAIN_PREFIX@@customer_group` (`customer_group_id`, `approval`, `company_id_display`, `company_id_required`, `tax_id_display`, `tax_id_required`, `sort_order`) VALUES
(1, 0, 1, 0, 0, 1, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_group_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@customer_group_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-- --------------------------------------------------------

--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_history`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_history` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_ip`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_ip` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_online`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_reward`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_reward` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@customer_transaction`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@customer_transaction` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@custom_field`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@custom_field` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@custom_field_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@custom_field_to_customer_group`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@custom_field_to_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@custom_field_value`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@custom_field_value` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@custom_field_value_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@download`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@download` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@download_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@download_description` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@extension`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@extension` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@extension`
--

INSERT INTO `@@DB_MAIN_PREFIX@@extension` (`extension_id`, `type`, `code`) VALUES
(23, 'payment', 'cod'),
(22, 'total', 'shipping'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@filter`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@filter` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@filter_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@filter_group`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@filter_group` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@filter_group_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@geo_zone`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@geo_zone` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@geo_zone`
--

INSERT INTO `@@DB_MAIN_PREFIX@@geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
(3, 'НДС', 'Облагаемые НДС', '2010-02-26 22:33:24', '2009-01-06 23:26:25');

-- --------------------------------------------------------

--
-- Структура таблицы `@@DB_MAIN_PREFIX@@information`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@information` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@information`
--

INSERT INTO `@@DB_MAIN_PREFIX@@information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@information_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@information_description` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@information_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@information_description` (`information_id`, `language_id`, `title`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`) VALUES
(4, 1, 'О нас', '&lt;p&gt;\r\n	О нас&lt;/p&gt;\r\n', '', '', '', ''),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@information_to_layout`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@information_to_store`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@information_to_store`
--

INSERT INTO `@@DB_MAIN_PREFIX@@information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@language`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@language` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@language`
--

INSERT INTO `@@DB_MAIN_PREFIX@@language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@layout`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@layout` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@layout`
--

INSERT INTO `@@DB_MAIN_PREFIX@@layout` (`layout_id`, `name`) VALUES
(1, 'Главная'),
(2, 'Продукт'),
(3, 'Категория'),
(4, 'По-умолчанию'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@layout_route`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@layout_route` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@layout_route`
--

INSERT INTO `@@DB_MAIN_PREFIX@@layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(30, 6, 0, 'account'),
(17, 10, 0, 'affiliate/'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@length_class`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@length_class` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@length_class`
--

INSERT INTO `@@DB_MAIN_PREFIX@@length_class` (`length_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 10.00000000),
(3, 0.39370000);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@length_class_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@length_class_description` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@length_class_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Сантиметр', 'см'),
(2, 1, 'Миллиметр', 'мм'),
(1, 2, 'Centimeter', 'cm'),
(2, 2, 'Millimeter', 'mm');
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@manufacturer`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@manufacturer` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@manufacturer`
--

INSERT INTO `@@DB_MAIN_PREFIX@@manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@manufacturer_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@manufacturer_description` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@manufacturer_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@manufacturer_description` (`manufacturer_id`, `language_id`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`) VALUES
(5, 1, '', '', '', '', ''),
(6, 1, '', '', '', '', ''),
(7, 1, '', '', '', '', ''),
(8, 1, '', '', '', '', ''),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@manufacturer_to_store`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@manufacturer_to_store` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@manufacturer_to_store`
--

INSERT INTO `@@DB_MAIN_PREFIX@@manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@option`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@option` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@option`
--

INSERT INTO `@@DB_MAIN_PREFIX@@option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 2),
(2, 'checkbox', 3),
(4, 'text', 4),
(5, 'select', 1),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@option_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@option_description` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@option_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@option_value`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@option_value` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@option_value`
--

INSERT INTO `@@DB_MAIN_PREFIX@@option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@option_value_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@option_value_description` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@option_value_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_download`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_download` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_field`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_field` (
  `order_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `custom_field_value_id` int(11) NOT NULL,
  `name` int(128) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_fraud`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_fraud` (
  `order_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_history`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_history` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_option`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_option` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_product`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_product` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_status`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_status` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@order_status`
--

INSERT INTO `@@DB_MAIN_PREFIX@@order_status` (`order_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Ожидание'),
(2, 1, 'В обработке'),
(3, 1, 'Доставлено'),
(7, 1, 'Отменено'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_total`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_total` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@order_voucher`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@order_voucher` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_attribute`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_attribute`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 2, 1, '4'),
(43, 4, 1, '8гб'),
(42, 3, 1, '100мгц'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_description` (`product_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`, `tag`) VALUES
(35, 1, 'Товар 8', '&lt;p&gt;\r\n	Товар 8&lt;/p&gt;\r\n', '', '', '', '', ''),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_discount`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_discount` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_discount`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_filter`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_image`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_image` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_image`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_option`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_option` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_option`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_option` (`product_option_id`, `product_id`, `option_id`, `option_value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_option_value`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_option_value` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_option_value`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_related`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_related`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_reward`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_reward` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_reward`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_special`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_special` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_special`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_to_category`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_to_category`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_to_category` (`product_id`, `category_id`, `main_category`) VALUES
(28, 20, 0),
(28, 24, 0),
(29, 20, 0),
(29, 24, 0),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_to_download`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_to_layout`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@product_to_store`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@product_to_store`
--

INSERT INTO `@@DB_MAIN_PREFIX@@product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@return`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@return` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@return_action`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@return_action` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@return_action`
--

INSERT INTO `@@DB_MAIN_PREFIX@@return_action` (`return_action_id`, `language_id`, `name`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@return_history`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@return_history` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@return_reason`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@return_reason` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@return_reason`
--

INSERT INTO `@@DB_MAIN_PREFIX@@return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@return_status`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@return_status` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@return_status`
--
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@review`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@review` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@setting`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@setting` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@setting`
--

INSERT INTO `@@DB_MAIN_PREFIX@@setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
...
(135, 0, 'config', 'config_encryption', '81c10c337562c9c3e1a97c0a2e12863a', 0),
...
(133, 0, 'config', 'config_email', '@@ADMIN_EMAIL@@', 0),
...
(134, 0, 'config', 'config_url', '@@ROOT_URL@@/', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `@@DB_MAIN_PREFIX@@stock_status`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@stock_status` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@stock_status`
--

INSERT INTO `@@DB_MAIN_PREFIX@@stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'В наличии'),
(8, 1, 'Предзаказ'),
(5, 1, 'Нет в наличии'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@store`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@store` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@tax_class`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@tax_class` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@tax_class`
--

INSERT INTO `@@DB_MAIN_PREFIX@@tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
(9, 'Налоги', 'Облагаемые налогом', '2009-01-06 23:21:53', '2011-03-09 21:17:10');

-- --------------------------------------------------------

--
-- Структура таблицы `@@DB_MAIN_PREFIX@@tax_rate`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@tax_rate` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@tax_rate`
--

INSERT INTO `@@DB_MAIN_PREFIX@@tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@tax_rate_to_customer_group`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@tax_rate_to_customer_group` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@tax_rate_to_customer_group`
--

INSERT INTO `@@DB_MAIN_PREFIX@@tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@tax_rule`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@tax_rule` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@tax_rule`
--

INSERT INTO `@@DB_MAIN_PREFIX@@tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@url_alias`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@url_alias` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@url_alias`
--

INSERT INTO `@@DB_MAIN_PREFIX@@url_alias` (`url_alias_id`, `query`, `keyword`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@user`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@user` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@user`
--


INSERT INTO `@@DB_MAIN_PREFIX@@user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, '@@ADMIN_NAME@@', '@@ADMIN_PASSWORD@@', '@@SALT@@', '', '', '@@ADMIN_EMAIL@@', '', '', 1, NOW());
-- --------------------------------------------------------

--
-- Структура таблицы `@@DB_MAIN_PREFIX@@user_group`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@user_group` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@user_group`
--

INSERT INTO `@@DB_MAIN_PREFIX@@user_group` (`user_group_id`, `name`, `permission`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@voucher`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@voucher` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@voucher_history`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@voucher_history` (
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@voucher_theme`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@voucher_theme` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@voucher_theme`
--

INSERT INTO `@@DB_MAIN_PREFIX@@voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@voucher_theme_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@voucher_theme_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Рождество'),
(7, 1, 'День рождения'),
(8, 1, 'Основной'),
(6, 2, 'Christmas'),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@weight_class`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@weight_class` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@weight_class`
--

INSERT INTO `@@DB_MAIN_PREFIX@@weight_class` (`weight_class_id`, `value`) VALUES
(1, 1.00000000),
(2, 1000.00000000);
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@weight_class_description`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@weight_class_description` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL,
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@weight_class_description`
--

INSERT INTO `@@DB_MAIN_PREFIX@@weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Килограммы', 'кг'),
(2, 1, 'Граммы', 'г'),
(1, 2, 'Kilogram', 'kg'),
(2, 2, 'Gram', 'g');
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@zone`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@zone` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@zone`
--

INSERT INTO `@@DB_MAIN_PREFIX@@zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
(1, 1, 'Бадахшан', 'BDS', 1),
(2, 1, 'Бадгис', 'BDG', 1),
(3, 1, 'Баглан', 'BGL', 1),
(4, 1, 'Балх', 'BAL', 1),
...
--
-- Структура таблицы `@@DB_MAIN_PREFIX@@zone_to_geo_zone`
--

CREATE TABLE IF NOT EXISTS `@@DB_MAIN_PREFIX@@zone_to_geo_zone` (
...
--
-- Дамп данных таблицы `@@DB_MAIN_PREFIX@@zone_to_geo_zone`
--

INSERT INTO `@@DB_MAIN_PREFIX@@zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
